describe('Basic user flow for Website', () => {
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    // Get the button inside shadow root
    ...
    // Check if the text is "Remove from Cart"
  ...
  it('Checking number of items in cart on screen', async () => {
    ...
    for (let i = 0; i < productItems.length; i++) {
      ...
      if (i === 0 || i === productItems.length - 1) {
        console.log(`Clicked index ${i}, text after: ${text}`);
      }
    }
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    // Wait for all product items to be ready
    ...
    for (let i = 0; i < productItems.length; i++) {
      ...
      if (buttonText !== 'Remove from Cart') {
        ...
        console.log(`❌ Item ${i} button text was: ${buttonText}`);
      }
    }
  ...
  it('Checking the localStorage to make sure cart is correct', async () => {
    ...
    // Check if it equals the expected string
  ...
  it('Checking number of items in cart on screen after removing from cart', async () => {
    ...
    for (let i = 0; i < productItems.length; i++) {
      ...
      // Only click if it's currently "Remove from Cart"
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    // Wait for all product-item elements to load
    await page.waitForSelector('product-item');
    ...
    for (let i = 0; i < productItems.length; i++) {
      ...
      if (buttonText !== 'Add to Cart') {
        allButtonsCorrect = false;
        console.log(`❌ Item ${i} button still says: ${buttonText}`);
      }
    }
